...
let initialOrders = [
  { id: 1, orderId: 'ORD001', customerName: 'Dheeraj', orderDate: '2024-03-15', status: 'Pending', expectedDeliveryDate: new Date() },
  ...
  { id: 4, orderId: 'ORD004', customerName: 'Dheeraj', orderDate: '2024-03-15', status: 'Pending', expectedDeliveryDate: new Date() }
];
